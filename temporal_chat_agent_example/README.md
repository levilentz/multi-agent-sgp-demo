# temporal-chat-agent-example - AgentEx Temporal Agent Template
...
agentex tasks submit --agent temporal-chat-agent-example --task "Your task here"
```
...
1. **Local Testing**
- Use `agentex agents run --manifest manifest.yaml` to run the agent locally
