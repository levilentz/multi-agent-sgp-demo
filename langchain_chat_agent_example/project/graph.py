...
from project.openai_client import OAI_MODEL, openai_client, sync_openai_client
...
async def create_graph():
    ...
    """
    llm = ChatOpenAI(model=MODEL_NAME, async_client=openai_client.chat.completions, client=sync_openai_client.chat.completions)
